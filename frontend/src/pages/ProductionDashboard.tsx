      ...
      <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/80 border border-blue-100/60 rounded-2xl p-6">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-4">
                ...
                {/* Sort/filter only make sense once there's a feed to act on. */}
            ...
            <div className="flex justify-between items-center">
              ...
              {/* Hide these when empty — the "No Following Yet" card below has its
                  own Browse/Explore CTAs, so showing them here too is 4 buttons
                  for 2 destinations. */}
              {followingPitches.length > 0 && (
        ...
        {activeTab === 'ndas' && (
          <div className="space-y-8">
            ...
            {/* NDA Summary block removed — it duplicated the four stats already
                shown in the header at the top of this tab. */}
          </div>
        )}
            ...
            {savedPitchItems.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                <div className="w-16 h-16 bg-brand-empty-icon/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Bookmark className="w-8 h-8 text-brand-empty-icon" />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">No Saved Pitches Yet</h3>
