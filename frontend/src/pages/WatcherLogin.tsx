...
import { Eye, LogIn, Mail, AlertCircle } from 'lucide-react';
          ...
          <form className="space-y-6" onSubmit={(e) => { void handleSubmit(e); }}>
            ...
            <div>
              ...
              <PasswordInput
                ...
                inputClassName="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-portal-watcher focus:border-transparent"
                placeholder="••••••••"
              />
            </div>
