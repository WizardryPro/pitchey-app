...
export default function NDAModal({
  ...
  }, [isOpen, formData.ndaType, pitchId]);
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                    <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200">
                      <h4 className="font-semibold text-sm text-gray-700">Pitchey Standard NDA</h4>
                      <a
                        href={`/legal/standard-nda?pitchId=${pitchId}`}
                        target="_blank"
                    ...
                    {standardNda ? (
                      <pre className="whitespace-pre-wrap font-sans text-xs leading-relaxed text-gray-700 p-4 max-h-56 overflow-y-auto">
                        {standardNda}
                      </pre>
                    ) : (
                      <p className="text-xs text-gray-500 p-4">Loading the standard agreement…</p>
                    )}
                    <p className="text-xs text-gray-500 px-4 pb-3">
                      The project name and disclosing party are filled from this pitch; the date and
                      both parties' names and addresses are completed when the agreement is signed.
                    </p>
                  </div>
                </div>
              )}
